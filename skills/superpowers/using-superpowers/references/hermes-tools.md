# Antigravity Agent Tool Mapping

Skills speak in actions ("dispatch a subagent", "create a todo", "read a file"). On Antigravity Agent these resolve to the tools below.
...
When a skill mentions "your instructions file," on Antigravity Agent this is **`AGENTS.md`** in the project directory, or **`SOUL.md`** globally at `~/.hermes/SOUL.md`.

## Invoking a skill

Antigravity Agent has a `skills` toolset with `skill_view` and `skills_list` tools.
