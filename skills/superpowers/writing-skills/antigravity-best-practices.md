...
```
pdf/
└── SKILL.md              # Minimal Skill: frontmatter + markdown instructions
```
...
├── FORMS.md              # Domain guide (loaded as needed)
└── reference.md          # Reference documentation (loaded as needed)
```
...
```
pdf/
├── SKILL.md              # Instructions referencing utility scripts
└── scripts/
    └── extract_text.py   # Executable script (executed via run_command)
```
